...
$y -= $yNext
$btnTestEmulatorBar = GUICtrlCreateButton("HIDE EMULATOR BAR" , $x  , $y , 140, 25)
$y -= $yNext
$btnTestAttackNowLB = GUICtrlCreateButton("2. ATTACK NOW LB" , $x  , $y , 140, 25)
$y -= $yNext
$btnTestCheckArmySpellCastel = GUICtrlCreateButton("1. Check Army Before Battle" , $x  , $y , 140, 25)
$y -= $yNext
If Not FileExists(@ScriptDir & "\AutoRaid.txt") Then
	GUICtrlSetState($btnTestAttackNowLB, $GUI_HIDE)
	GUICtrlSetState($btnTestCheckArmySpellCastel, $GUI_HIDE)
EndIf
